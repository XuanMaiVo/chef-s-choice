...
<head>
    ...
    <link rel="stylesheet" href="/chef%27schoice/chef-s-choice/css/style/user/payment.css">
</head>
<body>
    <div class="payment-header">
        <img src="/chef%27schoice/chef-s-choice/assets/images/chef's_choice_logo.png" alt="">
    </div>
            ...
            <div class="payment-items">
                <div class="payment-item">
                    <div class="p-item-product">
                        <img src="/chef%27schoice/chef-s-choice/assets/images/mau_dau_dieu.png" class="p-item-product-img">
    ...
    <script src="/chef%27schoice/chef-s-choice/js/payment.js"></script>
</body>
</html>