...
<head>
    ...
    <link rel="stylesheet" href="../../css/style/user/payment.css">
</head>
<body>
    <div class="payment-header">
        <img src="../../assets/images/chef's_choice_logo.png" alt="">
    </div>
            ...
            <div class="payment-items">
                <div class="payment-item">
                    <div class="p-item-product">
                        <img src="../../assets/images/mau_dau_dieu.png" class="p-item-product-img">
